...
- Lançamentos manuais podem ser excluídos definitivamente pelo proprietário com uma confirmação simples na própria listagem. Lançamentos técnicos de fatura, contas a pagar e investimentos continuam protegidos; transferências permanecem inativáveis e não são excluídas fisicamente pela interface.
...
- O saldo atual é o saldo inicial, mais receitas realizadas ativas, menos despesas realizadas ativas, mais transferências recebidas realizadas ativas e menos transferências enviadas realizadas ativas, sempre com data até o dia corrente no fuso de São Paulo.
- O saldo projetado parte do saldo atual e incorpora todos os lançamentos e transferências ativos com data futura, inclusive os previstos. Itens previstos vencidos continuam fora dos dois saldos até serem realizados ou remarcados.
- O extrato pertence à conta e combina receitas, despesas e o lado correspondente de cada transferência em ordem cronológica. O saldo linha a linha usa o realizado até hoje e passa a representar a projeção nas datas futuras; uma divisória visual separa os dois períodos.
