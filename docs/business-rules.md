...
- A central de relatórios usa a navegação principal da aplicação e agrupa seus tipos em uma faixa horizontal compacta abaixo do cabeçalho, preservando a largura principal para as matrizes. Os filtros permitem ajustar período, moedas de origem, contexto e regime quando aplicável.
...
- Recorrências apresenta somente regras automáticas de receitas e despesas; assinaturas e parcelas futuras permanecem na central de cartões para não misturar estruturas distintas.
