...
- A moeda inicial dos relatórios é a preferencial do perfil. Linhas de todas as moedas são convertidas para essa moeda de referência pela taxa implícita da transferência cambial concluída mais recente até a data analisada; na ausência de taxa anterior, usa-se a primeira posterior disponível. Uma ponte por outra moeda suportada é aceita. Valores sem rota de conversão ficam fora do total e geram aviso explícito.
...
- Assinaturas e parcelas futuras aparecem em Recorrências como informação de agenda, separadas das regras automáticas, para não gerar lançamentos duplicados.
